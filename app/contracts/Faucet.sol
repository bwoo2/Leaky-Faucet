...
contract Faucet {
    ...
    address payable owner; //deployer address
    ...
    function getCountryAddr(uint id) public view returns(address){
        return countries[id].currentCountry;
    }
...
/*
    function printAddress() public view returns (address payable[] memory){
